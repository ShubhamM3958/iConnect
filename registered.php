...
<head>
    ...
    <link rel="stylesheet" href="reg_success.css">
</head>
<body>
...
<div id="card" class="animated fadeIn">
    ...
    <div id="lower-side">
        <p id="message">
            🎉 Success! You're all set for the Event! Get ready to dive into a world of knowledge and excitement! See you there! 🚀 #Konark #iConnect
        </p>
